...
type G50BlockScanner struct {
	*bitcoin.BTCBlockScanner
	g50WM *WalletManager
}

//NewBTCBlockScanner 创建区块链扫描器
func NewG50BlockScanner(wm *WalletManager) *G50BlockScanner {
	bs := &G50BlockScanner{g50WM: wm}
...
func (bs *G50BlockScanner) GetBalanceByAddress(address ...string) ([]*openwallet.Balance, error) {
